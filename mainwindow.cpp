    ...
    ui(new Ui::MainWindow)
{
   ...
   // propertiesWidget->setLayout(properties);
    ...
    ui->toolBox->addItem(new ObjectsList(dir), "Городские дороги");
    dir.cdUp();
    dir.cd("highway/");
    ui->toolBox->addItem(new ObjectsList(dir), "Магистрали");
    dir.cdUp();
    dir.cd("outtown_roads/");
    ui->toolBox->addItem(new ObjectsList(dir), "Загородные дороги");
    dir.cdUp();
    dir.cd("elements/");
    ui->toolBox->addItem(new ObjectsList(dir), "Элементы");
